...
public class Hall1 extends JFrame implements ActionListener{
    ...
    public Hall1(Cinema cinema1,Cinema cinema2,Cinema cinema3,User user) {
        this.user=user;
        ...
        filmPanel = new JPanel(new GridLayout(4, 3,10,10)){
            ...
            protected void paintComponent(Graphics g) {
             ...
             film0 = new JButton(movieIcon);
                ...
                names = cinema1.getMovies().get(0).getShowTime().time.getHour();
                timeLabel = new JLabel("Time "+names);
                names = cinema1.getMovies().get(0).getShowTime().time.getDuration();
                durationLabel = new JLabel("Duration "+names);
                names = cinema1.getMovies().get(0).getShowTime().time.getDate();
        ...
        names = cinema1.getMovies().get(1).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(1).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(1).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(2).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(2).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(2).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(3).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(3).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(3).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(4).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(4).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(4).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(5).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(5).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(5).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(6).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(6).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(6).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(7).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(7).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(7).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(8).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(8).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(8).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(9).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(9).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(9).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(10).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(10).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(10).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
        ...
        names = cinema1.getMovies().get(11).getShowTime().time.getHour();
        timeLabel = new JLabel("Time "+names);
        names = cinema1.getMovies().get(11).getShowTime().time.getDuration();
        durationLabel = new JLabel("Duration "+names);
        names = cinema1.getMovies().get(11).getShowTime().time.getDate();
        dateLabel = new JLabel("Date "+names);
                dateLabel.setForeground(Color.white);
                durationLabel.setForeground(Color.white);
                timeLabel.setForeground(Color.white);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        else if(e.getSource()==userButton)
        {
            ...
            movie1 movie1 = new movie1(cinema1,cinema2,cinema3,user);
            movie1.setVisible(true);
            this.dispose();

        }
        else if (e.getSource()==film2) {
            movie2 movie2 = new movie2(cinema1,cinema2,cinema3,user);
            movie2.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film3) {
            movie3 movie3 = new movie3(cinema1,cinema2,cinema3,user);
            movie3.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film4) {
            movie4 movie4 = new movie4(cinema1,cinema2,cinema3,user);
            movie4.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film5) {
            movie5 movie5 = new movie5(cinema1,cinema2,cinema3,user);
            movie5.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film6) {
            movie6 movie6 = new movie6(cinema1,cinema2,cinema3,user);
            movie6.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film7) {
            movie7 movie7 = new movie7(cinema1,cinema2,cinema3,user);
            movie7.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film8) {
            movie8 movie8 = new movie8(cinema1,cinema2,cinema3,user);
            movie8.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film9) {
            movie9 movie9 = new movie9(cinema1,cinema2,cinema3,user);
            movie9.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film10) {
            movie10 movie10 = new movie10(cinema1, cinema2, cinema3, user);
            movie10.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film11) {
            movie11 movie11 = new movie11(cinema1,cinema2,cinema3,user);
            movie11.setVisible(true);
            this.dispose();
        }
        else if (e.getSource()==film12) {
            movie12 movie12 = new movie12(cinema1,cinema2,cinema3,user);
            movie12.setVisible(true);
            this.dispose();
        }
    }
}
